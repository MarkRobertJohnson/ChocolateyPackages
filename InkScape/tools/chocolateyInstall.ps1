try { #error handling is only necessary if you need to do anything in addition to/instead of the main helpers
  ...
  Install-ChocolateyPackage 'inkscape' 'exe' '/S' 'http://downloads.sourceforge.net/project/inkscape/inkscape/0.48.2/Inkscape-0.48.2-1-win32.exe?r=http%3A%2F%2Fsourceforge.net%2Fprojects%2Finkscape%2Ffiles%2Finkscape%2F&ts=1330204108&use_mirror=cdnetworks-us-2'
  ...
  #Write-ChocolateySuccess 'inkscape'
} catch {
