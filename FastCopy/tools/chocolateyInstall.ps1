try { #error handling is only necessary if you need to do anything in addition to/instead of the main helpers
  ...
  # Install-ChocolateyPackage 'FastCopy' 'exe' '/S /Language=English' 'http://my.vector.co.jp/servlet/System.FileDownload/download/http/0/360695/pack/win95/util/file/FastCopy208.zip' 'http://schinagl.priv.at/nt/hardlinkshellext/HardLinkShellExt_X64.exe'
  ...
  Install-ChocolateyZipPackage 'FastCopy' `
					  -url 'http://my.vector.co.jp/servlet/System.FileDownload/download/http/0/360695/pack/win95/util/file/FastCopy208.zip' `
					  -unzipLocation $binDir `
					  -url64bit 'http://my.vector.co.jp/servlet/System.FileDownload/download/http/0/360695/pack/win95/util/file/FastCopy208_x64.zip' 
  ...
  Write-ChocolateySuccess 'FastCopy'
} catch {
  Write-ChocolateyFailure 'FastCopy' "$($_.Exception.Message)"
  throw 
}
